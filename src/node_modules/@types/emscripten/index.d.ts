...
constructor();
        ...
        push_back(arg0: UnsignedChar): void;

        resize(arg0: UnsignedLong, arg1: UnsignedChar): void;

        size(): UnsignedLong;

        get(arg0: UnsignedLong): any;

        set(arg0: UnsignedLong, arg1: UnsignedChar): boolean;
        delete(): void;
}
export interface CustomEmbindModule {

        loader_check(arg0: string, arg1: string): string;

        loader_out(arg0: string, arg1: string): string;

        cmd_enc(arg0: unknown, arg1: UnsignedLong, arg2: unknown, arg3: string): void;

        cmd_dec(arg0: unknown, arg1: UnsignedLong, arg2: unknown, arg3: string): void;
        CharList: typeof CharList
}
